            ...
            <View style={styles.content}>
                <View style={styles.header}>
                    ...
                    <View style={styles.ratingContainer}>
                        ...
                        <Text style={styles.reviews}>({drinkData.reviews} đánh giá)</Text>
                    </View>
                </View>

                <View style={styles.categoryBadge}>
                    <Text style={styles.categoryText}>{drinkData.category}</Text>
                </View>

                <Text style={styles.price}>{drinkData.price.toLocaleString('vi-VN')}đ</Text>
