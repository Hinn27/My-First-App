...
import { View, Text, StyleSheet, Pressable, ScrollView, Alert, ActivityIndicator, Modal, TextInput, Animated } from 'react-native';
...
export default function HomeScreen() {
    ...
    const loadNearbyDishes = (coords) => {
        ...
        const mockDishes = [
            { id: 'nb-1', name: 'Phở Bò Đặc Biệt', price: 55000, rating: 4.9, restaurant: 'Phở Hà Nội', distance: 0.8, image: '🍜' },
            { id: 'nb-2', name: 'Bún Chả Hà Nội', price: 50000, rating: 4.8, restaurant: 'Bún Chả Đắc Kim', distance: 1.2, image: '🍲' },
            { id: 'nb-3', name: 'Cơm Tấm Sườn Bì', price: 45000, rating: 4.7, restaurant: 'Cơm Tấm Sài Gòn', distance: 1.5, image: '🍚' },
            { id: 'nb-4', name: 'Bánh Mì Thịt Nướng', price: 25000, rating: 4.9, restaurant: 'Bánh Mì Hòa Mã', distance: 0.5, image: '🥖' },
            { id: 'nb-5', name: 'Cà Phê Sữa Đá', price: 20000, rating: 4.8, restaurant: 'The Coffee House', distance: 0.9, image: '☕' },
            { id: 'nb-6', name: 'Trà Sữa Trân Châu', price: 35000, rating: 4.7, restaurant: 'Gong Cha', distance: 1.1, image: '🧋' },
            { id: 'nb-7', name: 'Bún Bò Huế', price: 50000, rating: 4.8, restaurant: 'Bún Bò Huế Miền Trung', distance: 2.0, image: '🍜' },
            { id: 'nb-8', name: 'Hủ Tiếu Nam Vang', price: 45000, rating: 4.6, restaurant: 'Hủ Tiếu Mỹ Tho', distance: 2.3, image: '🍜' },
        ];
    ...
    const handleSaveManualAddress = () => {
        ...
        // Validate
        if (!houseNumber.trim() || !street.trim() || !ward.trim() || !city.trim()) {
        ...
        <>
            <ScrollView style={styles.scrollContainer} showsVerticalScrollIndicator={false}>
                <View style={styles.header}>
                                ...
                                <View style={styles.addressRow}>
                                    {loadingLocation ? (
                                        ...
                                        <>
                                            ...
                                            <Ionicons name="chevron-down" size={16} color={theme.onSurface} />
                                        </>
                                    )}
                                </View>
                            </Pressable>
                    ...
                    <Link href="/cart" asChild>
                        <Pressable style={styles.cartButton}>
                            <Ionicons name="cart-outline" size={28} color={theme.onSurface} />
                            {getTotalItems() > 0 && (
                ...
                <Pressable style={styles.searchBar}>
                    ...
                    <Text style={styles.searchPlaceholder}>Tìm món ăn, đồ uống...</Text>
                </Pressable>
                ...
                <View style={styles.bannerContainer}>
                    <Pressable style={styles.banner}>
                        <View style={styles.bannerContent}>
                            ...
                            <Text style={styles.bannerSubtitle}>Giảm 30% cho đơn từ 100k</Text>
                        </View>
                        <Ionicons name="chevron-forward" size={20} color={theme.onPrimary} />
                    </Pressable>
                </View>
                    ...
                    >
                        <Link href="/food" asChild>
                            <Pressable style={styles.categoryItem}>
                                <View style={[styles.categoryIconCircle, { backgroundColor: theme.cardFood }]}>
                                    <Ionicons name="restaurant" size={26} color={theme.primary} />
                                </View>
                        ...
                        <Link href="/drink" asChild>
                            <Pressable style={styles.categoryItem}>
                                <View style={[styles.categoryIconCircle, { backgroundColor: theme.cardDrink }]}>
                                    <Ionicons name="cafe" size={26} color={theme.secondary} />
                                </View>
                        ...
                        <Pressable style={styles.categoryItem}>
                            <View style={[styles.categoryIconCircle, { backgroundColor: theme.cardPromo }]}>
                                <Ionicons name="flash" size={26} color={theme.error} />
                            </View>
                            <Text style={styles.categoryText}>Ưu Đãi</Text>
                        </Pressable>

                        <Pressable style={styles.categoryItem}>
                            <View style={[styles.categoryIconCircle, { backgroundColor: theme.cardFavorite }]}>
                                <Ionicons name="heart" size={26} color={theme.tertiary} />
                            </View>
                ...
                <View style={styles.section}>
                    <View style={styles.sectionHeader}>
                        <Text style={styles.sectionTitle}>Món ăn gần bạn (trong 3km)</Text>
                        <Pressable>
                    ...
                    {nearbyDishes.length > 0 ? (
                            ...
                            <Pressable key={item.id} style={styles.featuredCard}>
                                ...
                                <View style={styles.featuredInfo}>
                                    ...
                                    <View style={styles.featuredMeta}>
                                        ...
                                        <Text style={styles.featuredDot}>•</Text>
                                        <Text style={styles.featuredPrice}>{item.price.toLocaleString('vi-VN')}đ</Text>
                                    </View>
                                </View>

                                <Pressable style={styles.addButton} onPress={() => handleAddToCart({ id: item.id, name: item.name, price: item.price })}>
                        ...
                        <View style={styles.emptyState}>
                            <Ionicons name="location-outline" size={48} color={theme.onSurfaceVariant} />
                            <Text style={styles.emptyStateText}>Đang tải món ăn gần bạn...</Text>
                        </View>
                    )}
                </View>
            ...
            {showToast && (
                ...
                >
                    <Ionicons name="checkmark-circle" size={22} color={theme.onTertiary} />
                ...
                <View style={styles.modalOverlay}>
                    <View style={styles.modalContent}>
                        ...
                        <ScrollView showsVerticalScrollIndicator={false}>
                            ...
                            <View style={styles.formGroup}>
                                <Text style={styles.formLabel}>Tên đường *</Text>
                                <TextInput
                                    style={styles.formInput}
                            ...
                            <View style={styles.formGroup}>
                                ...
                                <TextInput
                                    ...
                                    onChangeText={(text) => setAddressForm({ ...addressForm, ward: text })}
                            ...
                            <Pressable style={styles.gpsButton} onPress={handleUseCurrentLocation}>
                                ...
                                <Text style={styles.gpsButtonText}>Sử dụng vị trí hiện tại</Text>
                            </Pressable>
